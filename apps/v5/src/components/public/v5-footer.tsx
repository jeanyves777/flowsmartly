    ...
    <Reveal>
      <LinearGradient
        ...
        {/* Deepens the gradient so the copy clears 4.5:1 on the lightest stop
          ...
          so every sibling below renders on top of it. Each palette's arc is
          authored against this scrim rather than rescued by it — grey's first
          stop scores 4.54:1 after the 22% pass. */}
