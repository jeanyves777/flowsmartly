...
export const AGENT_GROUPS: AgentGroup[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { id: "clone", title: "Clone yourself", description: "Your face in any scene, outfit or pose.", surface: "clone", thumb: "/Studio_Menus_Thumnail/Clone_Yourself/clone-main.webp", costKey: "AI_VISUAL_DESIGN", costHint: "from 15 cr", icon: "Camera", keywords: ["clone", "yourself", "identity", "headshot", "avatar", "photoshoot", "actor"] },
      { id: "podcast", title: "Video Podcast", description: "Multi-avatar podcast videos.", surface: "podcast", costKey: "AI_AVATAR_VIDEO_PREMIUM", costHint: "per minute", icon: "Mic", keywords: ["podcast", "video podcast", "interview", "two hosts", "conversation", "talk show", "co-host", "guest"] },
  ...
  },
  {
    ...
    skills: [
      ...
      { id: "messaging", title: "SMS / WhatsApp blast", description: "Reach your subscribers directly.", surface: "sms", thumb: "/Studio_Menus_Thumnail/grow/grow2.webp", tools: ["create_sms_campaign", "configure_whatsapp_agent"], costKey: "SMS_SEND", costHint: "~3 cr / text", icon: "MessageSquare", keywords: ["sms", "text", "whatsapp", "blast", "broadcast"] },
  ...
  },
  {
    ...
    skills: [
      { id: "find-leads", title: "Find local leads", description: "Scored, enriched contacts.", surface: "leads", thumb: "/Studio_Menus_Thumnail/Leads/Leads4.webp", tools: ["find_local_leads", "find_leads", "enrich_lead", "deep_enrich_lead"], costKey: "AI_WEB_SEARCH", costHint: "3 cr / search", icon: "Search", keywords: ["leads", "prospects", "find", "local", "enrich"] },
      { id: "lead-studio", title: "Lead Studio", description: "Find → automate → close.", surface: "leads", thumb: "/Studio_Menus_Thumnail/Leads/Leads1.webp", costHint: "Open", icon: "Target", keywords: ["lead studio", "crm", "pipeline", "opportunity"] },
      { id: "pitch", title: "Proposal / pitch", description: "Branded, ready to send.", surface: "pitchstudio", thumb: "/Studio_Menus_Thumnail/Leads/Leads3.webp", tools: ["create_proposal", "create_pitch", "update_pitch"], costKey: "AI_SERVICE_PROPOSAL", costHint: "from 8 cr", icon: "FileText", keywords: ["proposal", "pitch", "deck", "outreach", "sales"] },
      { id: "reviews", title: "Reviews & local SEO", description: "Grow your local presence.", surface: "reviews", thumb: "/Studio_Menus_Thumnail/Leads/Leads2.webp", tools: ["respond_to_review", "update_listing"], costKey: "AI_REVIEW_RESPONSE", costHint: "varies", icon: "Star", keywords: ["reviews", "local seo", "listing", "reputation", "google business"] },
      { id: "forms", title: "Forms & surveys", description: "Capture leads on your site.", surface: "forms", thumb: "/Studio_Menus_Thumnail/Leads/Leads6.webp", costHint: "Free", icon: "ClipboardList", keywords: ["form", "survey", "lead capture", "quiz"] },
      { id: "contacts", title: "Contacts", description: "Your CRM contacts & lists.", surface: "outreach", thumb: "/Studio_Menus_Thumnail/Leads/Leads5.webp", tools: ["add_contact", "update_contact"], costHint: "Free", icon: "UsersRound", keywords: ["contacts", "crm", "lists", "audience"] },
    ],
  },
  {
