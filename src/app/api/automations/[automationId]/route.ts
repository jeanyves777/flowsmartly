    ...
    return NextResponse.json({
      ...
      data: {
        automation: {
          ...
          imageSource: automation.imageSource,
          imageOverlayText: automation.imageOverlayText,
    ...
    return NextResponse.json({
      ...
      data: {
        automation: {
          ...
          imageUrl: updatedAutomation.imageUrl,
          imageSource: updatedAutomation.imageSource,
          imageOverlayText: updatedAutomation.imageOverlayText,
