    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8">
      ...
      {loading ? (
        ...
        >
          ...
          <p className="text-sm opacity-40 mt-1">Your order history will appear here</p>
          <Link
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center gap-2 mt-8">
              <button
                ...
                disabled={page === 1}
                className="px-3 py-1.5 rounded-lg border text-sm font-medium disabled:opacity-30 transition-opacity hover:opacity-80"
