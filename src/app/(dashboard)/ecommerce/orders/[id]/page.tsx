    ...
    <div className="space-y-3">
      ...
      {isRefunded && (
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-gray-700 font-medium">Refunded</span>
        </div>
      )}
    </div>
  );
  ...
  if (!order) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 text-center">
        ...
        <p className="text-sm text-gray-500 mt-1">{error || "The order could not be loaded."}</p>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center gap-3 mb-6">
        <Link href="/ecommerce/orders" className="p-2 hover:bg-gray-100 rounded-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="divide-y divide-gray-100">
              {order.items.map((item, idx) => (
                <div key={idx} className="flex items-center gap-4 py-3 first:pt-0 last:pb-0">
                  {item.imageUrl ? (
                    <img src={item.imageUrl} alt={item.name} className="w-12 h-12 rounded-lg object-cover border border-gray-200" />
                  ) : (
          ...
          {/* Shipping Address */}
          <div className="bg-white rounded-lg border border-gray-200 p-5">
            <h2 className="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">Shipping Address</h2>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-5">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-gray-600">{order.deliveryAssignment.driver.phone}</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
          ...
          {/* Notes Section */}
          <div className="bg-white rounded-lg border border-gray-200 p-5">
            <h2 className="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">Notes</h2>
            {order.notes ? (
              <pre className="text-sm text-gray-700 whitespace-pre-wrap font-sans mb-4 bg-gray-50 rounded-lg p-3">
                {order.notes}
              </pre>
            ) : (
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-gray-800 text-white text-sm font-medium rounded-lg hover:bg-gray-900 disabled:opacity-50 self-end"
              >
                Add
              </button>
            </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-5">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-900">{formatCents(order.shippingCents, order.currency)}</span>
              </div>
              <div className="flex justify-between text-sm">
              ...
              <div className="pt-2 border-t border-gray-200 flex justify-between text-sm font-semibold">
                ...
                <span className="text-gray-900">{formatCents(order.totalCents, order.currency)}</span>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-500 resize-none mb-4"
            />
      ...
      {showAssignModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">Select a driver to handle this delivery.</p>
            {loadingDrivers ? (
