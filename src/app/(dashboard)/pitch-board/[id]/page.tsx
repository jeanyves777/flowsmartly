...
function proposalTypeLabel(value: string | undefined) {
...
function ProposalDocumentWorkspace({
  proposal,
  businessName,
  businessUrl,
  brandName,
  ...
  businessUrl?: string;
  brandName: string;
  theme: ReturnType<typeof getProposalTheme>;
  isSaving: boolean;
