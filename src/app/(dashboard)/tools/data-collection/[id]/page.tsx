        ...
        {activeTab === "submissions" && (
          <div className="space-y-4">
            ...
            {subLoading ? (
              ...
              <>
                {/* Select All Bar */}
                <div className="flex items-center gap-3 px-4 py-2.5 bg-muted border border-border rounded-lg">
                  <input
                    type="checkbox"
                ...
                <div className="space-y-4">
                  {submissions.map(sub => {
                    const initials = sub.respondentName
                      ...
                      : "?";
                    return (
                      <div key={sub.id} className="bg-card border border-border rounded-xl shadow-sm">
                        {/* Card Header */}
                        <div className="flex items-center justify-between p-5 border-b border-border">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              {sub.respondentEmail && (
                                <p className="text-xs text-muted-foreground">{sub.respondentEmail}</p>
                              )}
                            </div>
                          </div>
                          <div className="flex items-center gap-3">
          ...
          <div className="max-w-lg mx-auto space-y-8">
            ...
            <div className="border border-border rounded-xl overflow-hidden">
              <div className="bg-muted px-4 py-2 border-b border-border">
                <span className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Public Page Preview</span>
              </div>
              <div className="p-6 space-y-4">
                ...
                <div className="text-center space-y-2">
                  {brand?.logo ? (
                    ...
                    <div className="h-10 w-10 mx-auto rounded-lg bg-muted flex items-center justify-center text-xs text-muted-foreground">Logo</div>
                  )}
                  <p className="text-sm font-medium text-muted-foreground">{brand?.name || "Your Business Name"}</p>
                </div>
                <div className="text-center">
        ...
        {activeTab === "send" && form && (
          <div className="max-w-lg mx-auto space-y-6">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Send this form to a contact list via email or SMS</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  >
                    <Mail className={`h-5 w-5 ${sendChannel === "email" && emailReady ? "text-blue-600" : "text-muted-foreground"}`} />
                ...
                <div>
                  ...
                  >
                    <MessageSquare className={`h-5 w-5 ${sendChannel === "sms" && smsReady ? "text-blue-600" : "text-muted-foreground"}`} />
                    <div className="text-left">
