...
import { Shield, CheckCircle2, XCircle, Clock, AlertTriangle, ExternalLink, Globe, MessageSquare, Search, Eye, ChevronDown, ChevronUp, RefreshCw } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <p className="text-sm text-muted-foreground">Review &amp; approve users&apos; SMS compliance submissions.</p>
        <Button
          variant="outline"
