  ...
  return (
    <div className="p-3">
      ...
      <AnimatePresence>
        ...
        {/* The legacy "Use as Background" / "Recreate as Editable"
            dialogs were removed in Phase 3 — Featured templates now
            load as pre-built editable composites; no per-template AI
            dialog needed. */}
        {searchModalOpen && (
          <TemplateSearchModal
            key="search"
