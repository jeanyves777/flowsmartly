      ...
      <div className="space-y-2 flex-1">
        <div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded px-2 py-1.5 flex items-center gap-1">
            ...
            <span className="text-[8px] text-gray-800 dark:text-gray-200">
              All Subscribers (2,847)
            </span>
          </div>
        </div>
        <div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded px-2 py-1.5">
            <div className="text-[7px] text-gray-800 dark:text-gray-200 leading-relaxed">
              Hey {"{name}"}! Flash sale today only - 40% off everything with
              code FLASH40. Shop now: {"{link}"}
            </div>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[6.5px] text-violet-500 font-medium">
  ...
  return (
    <div className="h-full bg-white dark:bg-gray-800 p-3 flex flex-col items-center justify-center gap-3">
      ...
      <div className="w-full max-w-[160px] space-y-1.5">
        {[
          ...
          <div key={step.label} className="flex items-center gap-1.5">
            ...
            <span
              className={`text-[6.5px] ${step.done ? "text-gray-600 dark:text-gray-400" : "text-brand-500 font-medium"}`}
            >
              {step.label}
            </span>
          </div>
      ...
      <div className="w-full max-w-[160px] bg-gray-100 dark:bg-gray-700 rounded-full h-2 overflow-hidden mt-1">
        <div
          className="h-full bg-gradient-to-r from-brand-400 to-brand-600 rounded-full animate-pulse"
          style={{ width: "67%" }}
        />
      </div>
      ...
      <div className="flex flex-col gap-1.5 flex-1">
        <div className="self-start max-w-[85%]">
          <div className="bg-white dark:bg-gray-700 rounded-2xl rounded-tl-sm p-2 shadow-sm">
            <div className="text-[7px] text-gray-800 dark:text-gray-200 leading-relaxed">
              <span className="font-bold">FlowSmartly:</span> Hey Sarah! Flash
              sale today only - 40% off everything with code FLASH40.
            </div>
          </div>
        ...
        <div className="self-start max-w-[85%] animate-[slideUp_0.3s_ease-out_0.6s_both]">
          <div className="bg-white dark:bg-gray-700 rounded-2xl rounded-tl-sm p-2 shadow-sm">
            <div className="text-[7px] text-gray-800 dark:text-gray-200">
              Glad you like it! Your order is confirmed.
            </div>
          </div>
        </div>
      </div>
...
function AnalyticsScreen() {
  return (
    <div className="h-full bg-white dark:bg-gray-800 p-3 flex flex-col">
      ...
      <div className="text-[6px] text-center text-gray-400 mt-1">
  ...
  return (
    <div className="h-full bg-gradient-to-b from-green-50 to-white dark:from-green-950 dark:to-gray-800 p-3 flex flex-col items-center justify-center gap-2">
      ...
      <div className="text-[7px] text-gray-500 text-center px-2">
        Every SMS campaign is TCPA-compliant with built-in consent management
      </div>
...
const blasterSteps = [
  {
    ...
    description:
      "Write your message or let AI generate it. Personalize with merge tags for each contact.",
    screen: "compose",
    icon: Send,
  },
  {
    ...
    description:
      "Messages are personalized, compliance-checked, and sent at optimal times for engagement.",
    screen: "sending",
    icon: Zap,
  },
  {
    ...
    description:
      "Recipients receive your message in seconds. Two-way conversations happen naturally.",
    screen: "delivered",
    icon: MessageSquare,
  },
  {
    ...
    description:
      "Track delivery rates, opens, clicks, and revenue attribution in real time.",
    screen: "analytics",
    icon: BarChart3,
  },
  {
    ...
    description:
      "TCPA-compliant by default. Consent management, opt-out handling, and audit trails included.",
    screen: "compliant",
    icon: Shield,
  },
];
...
export function SmsBlasterSection() {
  ...
  const advanceStep = useCallback(() => {
    ...
    setTimeout(() => {
      setIsClicking(false);
      setActiveStep((prev) => (prev + 1) % blasterSteps.length);
    }, 300);
  }, [isPaused]);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            SMS Blaster — Reach Everyone Instantly
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Send thousands of personalized SMS campaigns in seconds with built-in
            AI copywriting, compliance, and real-time analytics.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 via-teal-700 to-cyan-800 p-6 sm:p-10"
        >
          {/* Decorative elements */}
          ...
          <svg
            className="absolute top-8 right-12 w-20 h-20 opacity-10"
            viewBox="0 0 80 80"
            fill="none"
          >
            <rect x="4" y="4" width="56" height="40" rx="8" fill="white" />
            <polygon points="16,44 24,44 12,56" fill="white" />
            <rect x="20" y="36" width="56" height="40" rx="8" fill="white" />
            <polygon points="60,76 52,76 64,88" fill="white" />
          </svg>
              ...
              <div className="flex justify-center">
                ...
                >
                  <div className="w-52 sm:w-60">
                    <PhoneMockup>
                      {renderScreen(blasterSteps[activeStep].screen)}
                    </PhoneMockup>
                  </div>
                  {/* Hand cursor SVG */}
                  <div
                    className={`absolute -bottom-2 -right-4 sm:-right-6 transition-all duration-500 opacity-100 scale-100`}
                  >
                    <svg
                      width="40"
                      height="48"
        ...
        >
          {[
            ...
            <div
              key={stat.label}
              className="p-4 rounded-xl bg-card border text-center hover:shadow-lg transition-shadow"
            >
