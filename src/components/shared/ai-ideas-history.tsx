...
export function AIIdeasHistory({ contentType, onSelect, mode = "list", className }: AIIdeasHistoryProps) {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {/* Dropdown panel */}
      {isOpen && (
        <div className="absolute left-0 top-full mt-1.5 z-50 w-80 max-h-96 overflow-hidden rounded-xl border border-border/60 bg-background shadow-xl animate-in fade-in-0 zoom-in-95 slide-in-from-top-2 duration-150">
          {/* Header */}
