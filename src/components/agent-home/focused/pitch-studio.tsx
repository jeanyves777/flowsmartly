...
export function FocusedPitchStudio({ target, onAsk, refreshKey, onOpenView, onUseInAutomation }: { target: PitchTarget | null; onAsk: (p: string) => void; refreshKey?: number; onOpenView?: (key: string) => void; onUseInAutomation?: (t: { leadId?: string; leadName?: string; pitchId: string }) => void }) {
