  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-card rounded-xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-gradient-to-r from-violet-50 to-indigo-50 dark:from-violet-950/30 dark:to-indigo-950/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-foreground">AI Product Generator</h2>
              <p className="text-xs text-muted-foreground">Generate products with AI in seconds</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="p-6">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2.5 border border-border rounded-lg text-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 outline-none resize-none placeholder:text-muted-foreground bg-background"
                  maxLength={2000}
                />
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <input
                    ...
                    className="flex-1 h-2 bg-muted rounded-lg appearance-none cursor-pointer accent-violet-600"
                  />
                  <div className="flex items-center gap-1.5">
                    <input
                      ...
                      className="w-16 px-2 py-1.5 border border-border rounded-lg text-sm text-center focus:ring-2 focus:ring-violet-500 focus:border-violet-500 outline-none bg-background"
                    />
              ...
              {/* Credit cost */}
              <div className="flex items-center justify-between px-4 py-3 bg-violet-50 dark:bg-violet-950/30 rounded-lg">
                <div className="flex items-center gap-2">
                  <Sparkles className="h-4 w-4 text-violet-600" />
                  <span className="text-sm font-medium text-violet-900 dark:text-violet-300">Credit cost</span>
                </div>
                <div className="text-right">
                  <span className="text-lg font-bold text-violet-700 dark:text-violet-300">{totalCredits}</span>
                  <span className="text-sm text-violet-600 dark:text-violet-400 ml-1">credits</span>
                  <p className="text-xs text-violet-500 dark:text-violet-400">{CREDIT_COST_PER_PRODUCT} credits per product</p>
                </div>
              </div>
          ...
          {state === "loading" && (
            <div className="flex flex-col items-center justify-center py-12 space-y-4">
              ...
              <div className="text-center">
                <h3 className="text-lg font-semibold text-foreground">Generating Products...</h3>
          ...
          {state === "success" && (
            <div className="flex flex-col items-center justify-center py-12 space-y-4">
              ...
              <div className="text-center">
                <h3 className="text-lg font-semibold text-foreground">Products Generated!</h3>
                <p className="text-sm text-muted-foreground mt-1">
                  Successfully created <span className="font-semibold text-foreground">{generatedCount}</span> products
